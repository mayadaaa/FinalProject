...
public class RetreiveJokes extends AsyncTask<Void, Void, String> {

    @SuppressWarnings("unused")
    public static String LOG_TAG = RetreiveJokes.class.getSimpleName();
    ...
    public RetreiveJokes(Listener listener) {
        mListener = listener;
    }
